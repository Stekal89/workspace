    ...
    public class KonsumKreditController : Controller
    {
        ...
        public ActionResult KreditRahmen(KreditRahmenModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (Request.Cookies["KundenID"] == null)
                {
                    /// speichere Daten über BusinessLogic
                    aktKunde = KonsumKreditVerwaltung.ErzeugeKunde();
                }
                else
                {
                ...
                if (aktKunde != null && KonsumKreditVerwaltung.KreditRahmenSpeichern(model.GewuenschterBetrag, model.Laufzeit, aktKunde.ID))
                {
                    ...
                    Response.Cookies.Add(new HttpCookie("kundenID", aktKunde.ID.ToString()));
